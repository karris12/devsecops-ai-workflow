# devsecops-ai-workflow
Goal:
Build an automated AI workflow that performs security analysis on every GitHub Pull Request and posts a summarized report back as a PR comment.
